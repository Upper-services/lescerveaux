...
function Account() {
  ...
  const createPortalSession = async () => {
    ...
    const portalSession = await axios.post('/api/create-portal-session', {
      email: user.email,
      sessionId:
        'cs_test_a11592ei29qsX4aReake5xpVZWrxWXvu3MVcQAe7JDxU3nNyBYXSvfj2ve',
    })

    // Redirect user/customer to Customer Portal
